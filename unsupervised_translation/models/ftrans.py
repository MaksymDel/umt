...
class AllennlpTransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, source_embedder: TextFieldEmbedder, left_pad=False):
        ...
        self._seq2seq_encoder = StackedSelfAttentionEncoder(input_dim= source_embedder.get_output_dim(),
                                                    hidden_dim= args.encoder_embed_dim,
                                                    projection_dim= args.encoder_embed_dim / args.encoder_attention_heads,
                                                    feedforward_hidden_dim= args.encoder_ffn_embed_dim,
                                                    num_layers= args.encoder_layers,
                                                    num_attention_heads= args.encoder_attention_heads,
                                                    use_positional_encoding = True,
                                                    dropout_prob = args.dropout,
                                                    residual_dropout_prob = args.relu_dropout,
